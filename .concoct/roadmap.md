...
The initial CLI lifecycle through archival and one-shot execution is complete. Prioritize the
...
capabilities at CAP-013. Repeating and durable
orchestration then proceed as `CAP-013 → CON-033 → CON-034`. This keeps a
